...
import io.github.dockndevai.openbook.config.OpenbookProperties;
...
public class IngestionService {
	...
	/** Metadata keys. Must match what {@link io.github.dockndevai.openbook.chat.RagService} filters on. */
	...
	public int ingest(UUID documentId, byte[] content, String filename) {
		...
		OpenbookProperties.Ingest cfg = this.properties.getIngest();
