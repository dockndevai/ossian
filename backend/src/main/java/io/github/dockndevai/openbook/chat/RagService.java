...
public class RagService {
	...
	public RagService(VectorStore vectorStore, ChatClient.Builder chatClientBuilder, OpenbookProperties properties,
	...
	public List<Document> retrieve(String question, List<String> documentIds) {
		OpenbookProperties.Retrieval cfg = this.properties.getRetrieval();
